...
const buildGoogleOAuthUrl = (target) => {
  return (
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-animated relative">
      <div className="w-full max-w-md fade-up">
        {/* 로고 영역 */}
        <div className="text-center mb-12">
          <h1 className="text-[38px] font-extrabold tracking-tight fade-up">
            Even<span className="text-[#67594C]">Tee</span>
          </h1>
          <p
            className="mt-2 text-gray-500 text-sm fade-up"
        ...
        {/* 카드 박스 */}
        <div
          className="bg-white rounded-2xl shadow-lg p-10 border border-gray-100 scale-in"
        ...
        >
          ...
          <div className="flex flex-col gap-4">
            ...
            <button
              ...
              className="btn-ripple w-full bg-white border border-gray-300 text-gray-700 
